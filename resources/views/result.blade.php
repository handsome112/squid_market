                    ...
                    <div class="shop-widget">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select">
                                ...
                                <option value="{{ $currency }}" @if($currency==$currency_type) selected @endif>
                                    {{ $currency }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="product-card">
                            <div class="product-media">
                                <div class="product-label-lg">
                                    <label class="label-marquee label-text" style="height:44px;">
                                ...
                                <form method="post" action="{{ route('post.addtocart', ['product' => $product->id]) }}">
                                    ...
                                    <button class="product-add bg-success text-white">
                                        <img src="{{ asset('img/icons/cart.png') }}" width="16px"
                                            style="margin-right:2px"> Add to Cart
                                    </button>
                                </form>
                            </div>
                        </div>
